...
//		System.out.println(today.get(Calendar.AM_PM)); // 12시간
...
//		+ openDate.get(Calendar.HOUR_OF_DAY) + "시" // 24시간
//		+ openDate.get(Calendar.MINUTE) + "분"
//		+ openDate.get(Calendar.SECOND) + "초"
//		+ openDate.get(Calendar.MILLISECOND) + "밀리초");
		
		closeDate.clear();
		closeDate.set(2024, 3, 23, 17, 00);
...
//		+ closeDate.get(Calendar.HOUR_OF_DAY) + "시" // 24시간
//		+ closeDate.get(Calendar.MINUTE) + "분"
//		+ closeDate.get(Calendar.SECOND) + "초"
//		+ closeDate.get(Calendar.MILLISECOND) + "밀리초");
	}
